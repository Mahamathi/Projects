...
tk.Label(root, text="", font=('Helvetica', 12), fg='green' , textvariable=nsalText).place(x=100, y=150)
tk.Button(root, text="Convert", command=Ok ,height = 1, width = 8).place(x=100, y=110)
